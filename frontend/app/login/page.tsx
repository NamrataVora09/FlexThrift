            ...
            {activeTab === 'password' && (
              <form onSubmit={handlePasswordLogin}>
                ...
                <div className="auth-input-group" style={{ position: 'relative' }}>
                  ...
                  <i className={`bi ${showPassword ? 'bi-eye-slash' : 'bi-eye'}`} onClick={() => setShowPassword(!showPassword)}
                    style={{ position: 'absolute', right: 16, top: 40, cursor: 'pointer', color: '#999', fontSize: '1.1rem' }}></i>
                </div>
                <button type="submit" className="auth-btn" disabled={loading}>
