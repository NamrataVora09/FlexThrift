...
// code by shubham on 14032026
defined('ROLE_SELLER')   || define('ROLE_SELLER', 'seller');
defined('ROLE_BUYER')    || define('ROLE_BUYER', 'buyer');
defined('ROLE_BOTH')    || define('ROLE_BOTH', 'both');
defined('OFFER_ACCEPTED')    || define('OFFER_ACCEPTED', 'Accepted');
